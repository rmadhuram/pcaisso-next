...
export default function Page() {
  return (
    <div className={styles["intro"]}>
      ...
      <p className="explain">Can LLMs generate code to draw things? Pcaisso is a tool to explore, <br/>
        investigate and visualize the graphics generated by LLMs in response to prompts. 
      </p>
      <Button className="explore-button" type="submit" severity="success" size="large">
        Start Exploring!
      </Button>
      <h3>🌸 2D Canvas</h3>
